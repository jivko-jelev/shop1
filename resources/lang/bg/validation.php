...
return [
    ...
    */
    ...
    "max"                  => [
        "numeric" => "Полето :attribute трябва да бъде не повече от :max.",
        "file"    => "Полето :attribute трябва да бъде не повече от :max килобайта.",
        "string"  => "Полето :attribute трябва да бъде не повече от :max знака.",
    ...
    "name"                 => "Полето за :attribute може да съдържа само символи на кирилица и интервал",
    ...
    "unique"               => "Вече съществува такъв :attribute ",
