    ...
    ImagePickerOption = function () {
        ...
        _createClass(ImagePickerOption, [{
            ...
            value: function create_node() {
                var image, imgAlt, imgClass, thumbnail, removePicture;
                this.node = jQuery("<li/>");
                ...
                removePicture = `<i class="fa fa-lg fa-window-close remove-picture" data-picture-id="${this.option.val()}" aria-hidden="true" title="Изтрий тази снимка"></i>`;
                // Add custom class
                ...
                thumbnail.append(removePicture);
